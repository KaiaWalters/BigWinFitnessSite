...
const LoginForm = () => {
  return (
    <div className="relative w-full h-screen flex items-center justify-center text-white px-6">
      <form className="w-full max-w-sm p-8 rounded-lg shadow-lg border border-yellow-500">
        ...
        <div className="mb-4">
          ...
          <input 
            type="text" 
            id="name" 
            className="w-full mt-1 p-3 bg-green-700 text-white border border-yellow-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
        ...
        <div className="flex justify-between mt-6">
          <button className="w-1/2 bg-yellow-400 text-green-900 font-bold py-2 px-4 rounded-lg shadow-md hover:bg-yellow-500 transition">
            Log in
          </button>
